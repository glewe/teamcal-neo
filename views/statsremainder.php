      ...
      <div class="container content">
         ...
         <div class="panel panel-<?=$CONF['controllers'][$controller]->panelColor?>">
            ...
            <div class="panel-heading">
               <i class="<?=$CONF['controllers'][$controller]->faIcon?> fa-lg fa-header"></i><?=$LANG['stats_title_remainder']?>&nbsp;(<?=$viewData['year']?>)<span class="label label-default pull-right label-header-right"><i data-position="tooltip-bottom" class="tooltip-warning" data-toggle="tooltip" data-title="<?=$LANG['stats_total']?>"><?=$viewData['total']?></i></span><?=$pageHelp?>
            </div>
