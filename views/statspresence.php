      ...
      <div class="container content">
         ...
         <div class="panel panel-<?=$CONF['controllers'][$controller]->panelColor?>">
            ...
            <div class="panel-heading">
               <i class="fa fa-<?=$CONF['controllers'][$controller]->faIcon?> fa-lg fa-menu"></i><?=$LANG['stats_title_presences']?>&nbsp;(<?=$viewData['periodName']?>)&nbsp;<span class="label label-default pull-right"><i data-position="tooltip-bottom" class="tooltip-warning" data-toggle="tooltip" data-title="<?=$LANG['stats_total']?>"><?=$viewData['total']?></i></span><?=$pageHelp?>
            </div>
