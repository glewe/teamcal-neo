...
<div class="container content">
  ...
  <div class="col-lg-12">
    ...
    <div class="card">
      ...
      ?>
      <div class="card-header text-bg-<?= $CONF['controllers'][$controller]->panelColor ?>"><i class="<?= $CONF['controllers'][$controller]->faIcon ?> fa-lg me-3"></i><?= $LANG['msg_title'] . " " . $UL->firstname . " " . $UL->lastname . $pageHelp ?></div>
      <div class="card-body">
