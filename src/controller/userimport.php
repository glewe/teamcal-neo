                ...
                if (($handle = fopen($uplDir . $UPL->the_file, "r")) !== FALSE) {
                    ...
                    while (($arr = fgetcsv($handle, 1000, ";")) !== FALSE) {
                        ...
                        if (is_array($arr) && !empty($arr)) {
                            ...
                            $U->email = $CSVemail;
                            if (isset($_POST['sel_role'])) $U->role = $_POST['sel_role'];
                            else $U->role = '2';
                            if (isset($_POST['chk_hidden']) && $_POST['chk_hidden']) $U->hidden = '1';
                            else $U->hidden = '0';
                            if (isset($_POST['chk_locked']) && $_POST['chk_locked']) $U->locked = '1';
                            else $U->locked = '0';
                            $U->onhold = '0';
                            $U->verify = '0';
                            $U->bad_logins = '0';
