...
if (!empty($_POST)) {
    ...
    if (isset($_POST['btn_bulkUpdate'])) {
        ...
        //
        $inputError = false;
        if (isset($_POST['txt_selected_' . $absid . '_allowance']) && strlen($_POST['txt_selected_' . $absid . '_allowance']) && !formInputValid('txt_selected_' . $absid . '_allowance', 'numeric')) $inputError = true;
        if (isset($_POST['txt_selected_' . $absid . '_carryover']) && strlen($_POST['txt_selected_' . $absid . '_carryover']) && !formInputValid('txt_selected_' . $absid . '_carryover', 'numeric')) $inputError = true;
        foreach ($users as $user) {
            if (isset($_POST['txt_' . $user['username'] . '_' . $absid . '_allowance']) && strlen($_POST['txt_' . $user['username'] . '_' . $absid . '_allowance']) && !formInputValid('txt_' . $user['username'] . '_' . $absid . '_allowance', 'numeric')) $inputError = true;
            if (isset($_POST['txt_' . $user['username'] . '_' . $absid . '_carryover']) && strlen($_POST['txt_' . $user['username'] . '_' . $absid . '_carryover']) && !formInputValid('txt_' . $user['username'] . '_' . $absid . '_carryover', 'numeric')) $inputError = true;
        }
        ...
        if (!$inputError && isset($_POST['chk_userSelected'])) {
            ...
            foreach ($selected_users as $su => $value) {
                ...
                } else if (isset($_POST['txt_' . $value . '_' . $absid . '_allowance']) && strlen($_POST['txt_' . $value . '_' . $absid . '_allowance'])) {
                ...
                } else if (isset($_POST['txt_' . $value . '_' . $absid . '_carryover']) && strlen($_POST['txt_' . $value . '_' . $absid . '_carryover'])) {
...
foreach ($users as $user) {
    ...
    if ($user['firstname'] != "") $thisuser['dispname'] = $user['lastname'] . ", " . $user['firstname'];
    else $thisuser['dispname'] = $user['lastname'];
