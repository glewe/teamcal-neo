...
$viewData['enddate'] = '';
$viewData['user'] = $for;
if ($for == 'all') $viewData['userFullname'] = $LANG['all'];
else $viewData['userFullname'] = $U->getFullname($for);
...
if (!empty($_POST)) {
    ...
    if (isset($_POST['chk_confidential'])) $viewData['confidential'] = '1';
    else $viewData['confidential'] = '0';
