...
$CONF['controllers'] = array(
  ...
  'patterns' => new Controller('patterns', 'fas fa-calendar-days', $CONF['menuIconColor'], 'primary', 'patternedit', 'Absence Patterns', 'https://lewe.gitbook.io/teamcal-neo/administration/absence-patterns/'),
  'patternadd' => new Controller('patternadd', 'fas fa-calendar-days', $CONF['menuIconColor'], 'primary', 'patternedit', 'Add Absence Pattern', 'https://lewe.gitbook.io/teamcal-neo/administration/absence-patterns/'),
  'patternedit' => new Controller('patternedit', 'fas fa-calendar-days', $CONF['menuIconColor'], 'primary', 'patternedit', 'Edit Absence Pattern', 'https://lewe.gitbook.io/teamcal-neo/administration/absence-patterns/'),
