...
$CONF['controllers'] = array(
    ...
    'bulkedit' => new Controller('bulkedit', 'fas fa-check-square', $CONF['menuIconColor'], 'danger', 'admin', 'Bulk Edit', 'https://support.lewe.com/docs/teamcal-neo-manual/administration/absence-types/bulk-edit/'),
