...
$CONF['controllers'] = array(
    ...
    'bulkedit' => new Controller('bulkedit', 'fas fa-check-square', $CONF['menuIconColor'], 'danger', 'admin', 'Allowance Bulk Edit', 'https://support.lewe.com/docs/teamcal-neo-manual/administration/allowance-bulk-edit/'),
