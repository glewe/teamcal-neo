...
if (!empty($_POST)) {
  ...
  if (isset($_POST['btn_install'])) {
    if (
      ...
      (isset($_POST['txt_instDbServer']) && strlen($_POST['txt_instDbServer'])) and
      (isset($_POST['txt_instDbName']) && strlen($_POST['txt_instDbName'])) and
...
// PREPARE VIEW
//
if (!$installationComplete && readDef('APP_INSTALLED', $configAppFile) <> '0') {
  //
  ...
  <div class="col-lg-12">
    ...
    <?php if (!$installationExecuted && !$installationComplete) { ?>
      <form class="form-control-horizontal" action="installation.php" method="post" target="_self" accept-charset="utf-8">
        ...
        <div class="card">
          <div class="card-header"><i class="fas fa-cog fa-lg"></i>&nbsp;<?= readConfig('app_name', $configAppFile) ?> <?= readConfig('app_version', $configAppFile) ?> Installation<a href="https://lewe.gitbook.io/teamcal-neo/installation" target="_blank" class="float-end" style="color:inherit;"><i class="fas fa-question-circle fa-lg"></i></a></div>
          <div class="card-body">
            ...
            <div class="form-group row">
              ...
              <div class="col-lg-4">
                <div class="checkbox">
                  <label><input type="checkbox" id="chk_licApp" name="chk_licApp" value="chk_activateMessages" tabindex="<?= $tabindex++ ?>"><a href="https://lewe.gitbook.io/teamcal-neo/readme/teamcal-neo-license" target="_blank"><?= $LANG['inst_lic_app'] ?></a></label>
                </div>
              </div>
            </div>
            <div class="divider">
...
<footer class="footer">
  ...
  <div class="container">
    <div class="col-lg-12 text-end text-italic xsmall"><?= APP_POWERED ?></div>
  </div>
