...
$LANG['cookie_message'] = 'Diese Applikation nutzt ein Session Cookie um den aktuell eingeloggten Benutzer zu identifizieren. In diesem Cookie sind keine pers&ouml;nlichen Daten abgelegt.';
...
$LANG['alert_csrf_invalid_subject'] = 'Sicherheits-Token Ung&uuml;ltig';
$LANG['alert_csrf_invalid_text'] = 'Die Anfrage enthielt ein fehlendes oder ung&uuml;tliges Sicherheits-Token.';
...
$LANG['config_alert_failed'] = 'Die Konfiguration konnte nicht gespeichert werden. Bitte &uuml;berpr&uuml;fe die Eingaben.';
...
$LANG['config_matomoAnalytics_comment'] = $appTitle . ' unterst&uuml;tzt Matomo Analytics. Wenn du die Zugriffe auf deine Instanz
 von Matomo Analytics tracken lassen willst, ticke die Checkbox hier und trage deine Matomo URL und Matomo SiteId ein. Der entsprechende Javascript Code wird dann eingef&uuml;gt.';
...
$LANG['config_userManual_comment'] = $appTitle . '\'s Nutzerhandbuch ist in Englisch verf&uuml;gbar auf der <a href="https://lewe.gitbook.io/teamcal-neo/" target="_blank">Lewe Gitbook site</a>.
...
$LANG['config_welcomeText_comment'] = 'Hier kann ein ein Text f&uuml;r die Startseite eingegeben werden. Die folgenden HTML Tags sind erlaubt:<br>
...
$LANG['group_managers_comment'] = 'W&auml;hle die Manager dieser Gruppe aus.<br>Gruppenmanager k&ouml;nnen Einstellungen, Mitglieder und Manager der Gruppe bearbeiten.';
...
$LANG['lic_unavailable'] = 'Lizenzdaten Nicht Verf&uuml;gbar';
$LANG['lic_unavailable_subject'] = 'Datenabruf Problem';
$LANG['lic_unavailable_text'] = 'Die Information f&uuml;r diese Lizenz konnten nicht abgerufen werden.';
$LANG['lic_unavailable_help'] = 'Sollte dieses Problem weiterhin auftreten &ouml;ffne bitte ein Ticket im Lewe Service Desk (der Link ist auf der &Uuml;ber Seite zu finden).';
...
$LANG['msg_email_off_text'] = 'In dieser Installation sind E-mail Benachrichtigungen ausgeschaltet. Ein Administrator kann dies &auml;ndern.';
...
$LANG['users_confirm_password'] = 'Bist du sicher, dass du die Passw&ouml;rter der ausgew&auml;hlten Nutzer zur&uuml;cksetzen m&ouml;chtest? Eine E-mail mit der Aufforderung zur Passwort&auml;nderung wird an die Nutzer versendet.';
