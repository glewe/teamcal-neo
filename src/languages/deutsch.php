...
$LANG['config_menuBarBg_danger'] = '<i class="fas fa-user-circle text-danger"></i>';
$LANG['config_menuBarBg_dark'] = '<i class="fas fa-user-circle text-dark"></i>';
$LANG['config_menuBarBg_info'] = '<i class="fas fa-user-circle text-info"></i>';
$LANG['config_menuBarBg_light'] = '<i class="fas fa-user-circle text-light"></i>';
$LANG['config_menuBarBg_primary'] = '<i class="fas fa-user-circle text-primary"></i>';
$LANG['config_menuBarBg_secondary'] = '<i class="fas fa-user-circle text-secondary"></i>';
$LANG['config_menuBarBg_success'] = '<i class="fas fa-user-circle text-success"></i>';
$LANG['config_menuBarBg_transparent'] = '<i class="fas fa-user-circle text-transparent"></i>';
$LANG['config_menuBarBg_warning'] = '<i class="fas fa-user-circle text-warning"></i>';
$LANG['config_menuBarBg_white'] = '<i class="fas fa-user-circle text-white"></i>';
