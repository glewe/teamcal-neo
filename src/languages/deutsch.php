...
$LANG['avatar'] = 'Avatar';
$LANG['back_to_top'] = 'Zurück zum Anfang';
$LANG['blue'] = 'Blau';
$LANG['close_this_message'] = 'Diese Nachricht schließen';
...
$LANG['orange'] = 'Orange';
$LANG['partially_approved'] = 'Teilweise bestätigt';
...
$LANG['about_for'] = 'für';
$LANG['about_and'] = 'und';
$LANG['about_majorUpdateAvailable'] = 'Major Update verfügbar...';
$LANG['about_minorUpdateAvailable'] = 'Minor oder Patch Update verfügbar...';
$LANG['about_misc'] = 'viele Nutzer für Tests und Vorschläge...';
$LANG['about_newestVersion'] = 'Du hast die aktuellste Version';
$LANG['about_view_releaseinfo'] = 'Releaseinformation';
$LANG['about_bugfixes'] = 'Fehlerbehebungen';
$LANG['about_features_new'] = 'Neue Funktionen';
$LANG['about_features_retired'] = 'Entfernte Funktionen';
$LANG['about_improvements'] = 'Verbesserungen';
...
$LANG['alert_captcha_wrong_help'] = 'Der Sicherheitscode muss genau wie angezeigt eingegeben werden. Groß- und Kleinschreibung spielt dabei keine Rolle.';
...
$LANG['alert_input_pwdmedium'] = 'Das Passwort muss mindestens 6 Zeichen lang sein, mindestens einen Kleinbuchstaben, einen Großbuchstaben und eine Zahl enthalten.
 Erlaubt sind Klein- und Großbuchstaben, Zahlen und die folgenden Sonderzeichen: !@#$%^&amp;*().';
$LANG['alert_input_pwdhigh'] = 'Das Passwort muss mindestens 8 Zeichen lang sein, mindestens einen Kleinbuchstaben, einen Großbuchstaben, eine Zahl und ein Sonderzeichen enthalten.
 Erlaubt sind Klein- und Großbuchstaben, Zahlen und die folgenden Sonderzeichen: !@#$%^&amp;*().';
...
$LANG['att_confirm_delete'] = 'Bist du sicher, dass du die ausgewählten Dateien löschen möchtest?';
$LANG['att_extensions'] = 'Erlaubte Bildformate';
$LANG['att_file'] = 'Datei hochladen';
$LANG['att_file_comment'] = 'Hier kann eine Datei hochgeladen werden. Die Dateigröße ist limitiert auf %d KBytes und die erlaubten Formate sind "%s".';
$LANG['att_maxsize'] = 'Maximale Dateigröße';
$LANG['att_owner_access'] = 'Der Uploader hat immer Zugriff.';
$LANG['att_shareWith'] = 'Teilen mit';
$LANG['att_shareWith_comment'] = 'Wähle die Gruppen oder Benutzer, mit denen du diese Datei teilen willst. Hinweis: Diese Benutzer müssen Zugriff auf diese Seite habe, um auf die Datei zuzugreifen.';
...
$LANG['btn_confirm'] = 'Bestätigen';
$LANG['btn_confirm_all'] = 'Alle bestätigen';
...
$LANG['btn_delete_all'] = 'Alle löschen';
$LANG['btn_delete_group'] = 'Gruppe löschen';
$LANG['btn_delete_holiday'] = 'Feiertag löschen';
$LANG['btn_delete_records'] = 'Datensätze löschen';
$LANG['btn_delete_role'] = 'Rolle löschen';
$LANG['btn_delete_selected'] = 'Auswahl löschen';
...
$LANG['btn_reset_database'] = 'Datenbank zurücksetzen';
$LANG['btn_reset_password'] = 'Passwort zurücksetzen';
$LANG['btn_reset_password_selected'] = 'Auswahl Passwort zurücksetzen';
...
// Data Privacy Policy
//
$LANG['gdpr_title'] = 'Datenschutzbestimmungen gemäß DSVGO';
...
$LANG['group_managers_comment'] = 'Wähle die Manager dieser Gruppe aus.<br>Gruppenmanager können Einstellungen, Mitglieder und Manager der Gruppe bearbeiten.';
$LANG['group_members'] = 'Mitglieder dieser Gruppe';
$LANG['group_members_comment'] = 'Wähle die Mitglieder dieser Gruppe aus.';
...
$LANG['groups_alert_group_created_fail'] = 'Die Gruppe wurde nicht angelegt. Bitte überprüfe den "Gruppe anlegen" Dialog nach Eingabefehlern.';
$LANG['groups_alert_group_deleted'] = 'Die Gruppe wurde gelöscht.';
$LANG['groups_confirm_delete'] = 'Bist du sicher, dass du diese Gruppe löschen willst?';
...
$LANG['imprint'] = array(
  ...
  array(
    ...
    'text' => '<p>Die Inhalte, die mit der ' . $appTitle . ' Applikation ausgeliefert werden, wurden sorgfältig vorbereitet und
      ...
      elektronisch oder mechanisch, egal für welchen Zweck ohne ausdrückliche Erlaubnis von George Lewe.</p>',
  ),
  array(
    'title' => 'Links',
...
if ($C->read('googleAnalytics') && $C->read("googleAnalyticsID")) {
  $LANG['imprint'][] = array(
    ...
    'text' => '<p><i class="fab fa-google fa-3x me-3 float-start" style="color: #999999;"></i>Diese Website benutzt Google Analytics, einen Webanalysedienst der Google Inc.
      ...
      durch Sie ermöglichen. Die durch den Cookie erzeugten Informationen über die Nutzung dieser Website werden an Server von Google übertragen und
      dort gespeichert. Diese Server können sich den USA befinden.</p>
      <div class="collapse" id="readmore">
         <p>Im Falle der Aktivierung der IP-Anonymisierung auf dieser Webseite, wird Ihre IP-Adresse von Google jedoch innerhalb von Mitgliedstaaten der Europäischen
         ...
         Server von Google in den USA übertragen und dort gekürzt. Die IP-Anonymisierung ist auf dieser Website aktiv. Im Auftrag des Betreibers dieser Website wird Google
         diese Informationen benutzen, um Ihre Nutzung der Website auszuwerten, um Reports über die Websiteaktivitäten zusammenzustellen und um weitere mit der Websitenutzung
         und der Internetnutzung verbundene Dienstleistungen gegenüber dem Websitebetreiber zu erbringen.</p>
         <p>Die im Rahmen von Google Analytics von Ihrem Browser übermittelte IP-Adresse wird nicht mit anderen Daten von Google zusammengeführt. Sie können die Speicherung
         ...
         sämtliche Funktionen dieser Website vollumfänglich werden nutzen können. Sie können darüber hinaus die Erfassung der durch das Cookie erzeugten und auf Ihre Nutzung
         ...
         verfügbare Browser-Plugin herunterladen und installieren: <a href="https://tools.google.com/dlpage/gaoptout?hl=de">https://tools.google.com/dlpage/gaoptout?hl=de</a>.</p>
         <p>Alternativ zum Browser-Add-On oder innerhalb von Browsern auf mobilen Geräten, <a id="GAOptOut" title="Google Analytics Opt-Out-Cookie setzen" href="javascript:gaOptout()">
         klicken Sie bitte diesen Link</a>, um die Erfassung durch Google Analytics innerhalb dieser Website zukünftig zu verhindern (das Opt Out funktioniert nur in dem Browser
...
$LANG['log_clear'] = 'Periode löschen';
$LANG['log_clear_confirm'] = 'Bist du sicher, dass du alle Ereignisse in der angezeigten Periode löschen willst?<br>
      Es werden alle Ereignisse jedes Ereignistyps in dieser Periode gelöscht, auch wenn sie in den Logbuch-Einstellungen verborgen wurden.';
...
// Messages
//
$LANG['msg_title'] = 'Benachrichtigungen für: ';
$LANG['msg_title_edit'] = 'Benachrichtigung Erstellen';
$LANG['msg_code'] = 'Sicherheitscode';
$LANG['msg_code_comment'] = 'Bitte geben Sie den Code ein wie angezeigt. Groß- und Kleinschreibung ist nicht relevant.';
$LANG['msg_code_new'] = 'Neues Bild laden';
$LANG['msg_confirm_all_confirm'] = 'Bist du sicher, dass du alle Benachrichtigungen bestätigen willst?';
$LANG['msg_confirm_confirm'] = 'Bist du sicher, dass du die Benchrichtigung "%s" bestätigen willst? Sie wird nicht gelöscht aber nicht mehr automatisch angezeigt.';
...
$LANG['msg_content_type_primary'] = 'Primär';
$LANG['msg_content_type_success'] = 'Erfolg';
$LANG['msg_content_type_warning'] = 'Warnung';
$LANG['msg_content_type_danger'] = 'Gefahr';
$LANG['msg_delete_all_confirm'] = 'Bist du sicher, dass du alle Benchrichtigungen löschen willst?';
$LANG['msg_delete_confirm'] = 'Bist du sicher, dass du die Benchrichtigung "%s" löschen willst?';
$LANG['msg_email_off_subject'] = 'E-mail Benachrichtigungen ausgeschaltet';
$LANG['msg_email_off_text'] = 'In dieser Installation sind E-mail Benachrichtigungen ausgeschaltet. Ein Administrator kann dies ändern.';
...
$LANG['msg_msg_sent_text'] = 'Deine Benachrichtigung wurde an die ausgewählten Empfänger gesendet.';
$LANG['msg_no_file_subject'] = 'Keine Datei ausgewählt';
$LANG['msg_no_file_text'] = 'Es muss mindestens eine Datei für diese Operation ausgewählt werden.';
$LANG['msg_no_group_subject'] = 'Keine Gruppe ausgewählt';
$LANG['msg_no_group_text'] = 'Es muss mindestens eine Gruppe ausgewählt werden, an die die Benachrichtigung gesendet werden soll.';
$LANG['msg_no_text_subject'] = 'Kein Betreff und/oder Text';
$LANG['msg_no_text_text'] = 'Es muss ein Betreff und ein Text für die Benachrichtigung eingegeben werden.';
$LANG['msg_no_user_subject'] = 'Kein Benutzer ausgewählt';
$LANG['msg_no_user_text'] = 'Es muss mindestens ein Nutzer ausgewählt werden, an den die Benachrichtigung gesendet werden soll.';
$LANG['msg_sendto'] = 'Empfänger';
$LANG['msg_sendto_desc'] = 'Wähle hier den oder die Empfänger der Benachrichtigung aus.';
$LANG['msg_sendto_all'] = 'Alle';
$LANG['msg_sendto_group'] = 'Gruppe:';
$LANG['msg_sendto_user'] = 'Nutzer:';
$LANG['msg_type'] = 'Benachrichtigungstyp';
$LANG['msg_type_desc'] = 'Hier kann der Benachrichtigungstyp ausgewählt werden.<br>
      Eine stille Benachrichtigung wird nur auf die Benachrichtigungsseite gesetzt.<br>
      Eine Prompt Benachrichtigung führt dazu, dass die Benachrichtigungsseite automatisch angezeigt wird, wenn sich der Benutzer einlogt.';
...
// Modal dialogs
//
$LANG['modal_confirm'] = 'Bitte Bestätigen';
...
$LANG['page_next'] = 'Zur nächsten Seite...';
...
$LANG['perm_create_scheme_desc'] = 'Gib einen Namen für das neue Schema ein. Es wird mit Standardeinstellungen direkt geladen. Alle nicht gespeicherten Änderungen des momentanen Schemas gehen verloren.';
$LANG['perm_delete_scheme'] = 'Schema löschen';
$LANG['perm_delete_confirm'] = 'Soll dieses Berechtigungsschema gelöscht werden? Dadurch wird das Standard Schema geladen und aktiviert.';
$LANG['perm_inactive'] = '(Inaktiv)';
$LANG['perm_reset_scheme'] = 'Schema zurücksetzen';
$LANG['perm_reset_confirm'] = 'Soll dieses Berechtigungsschema auf das "Default" Schema zurückgesetzt werden?';
$LANG['perm_save_scheme'] = 'Schema speichern';
$LANG['perm_select_scheme'] = 'Schema auswählen';
$LANG['perm_select_confirm'] = 'Soll dieses Berechtigungsschema geladen werden? Alle nicht gespeicherten Änderungen des momentanen Schemas gehen verloren.';
...
$LANG['perm_upload_title'] = 'Anhänge';
...
$LANG['perm_useradmin_title'] = 'Benutzerprofil (Anzeigen und Hinzufügen)';
$LANG['perm_useradmin_desc'] = 'Erlaubt das Listen und Hinzufügen von Benutzerkonten.';
...
$LANG['perm_viewprofile_desc'] = 'Erlaubt den Zugriff auf die Nutzerprofil-Anzeige-Seite mit Basisinformationen wie Name oder Telefonnummer. Das Anzeigen von User Popups ist ebenfalls abhängig von dieser Berechtigung.';
...
$LANG['profile_2fa_optional'] = 'TeamCal Neo erlaubt das Einrichten eines zweiten Faktors für die Authentifizierung, z.B. mit dem Google oder Microsoft Authenticator auf deinem mobilen Gerät.<br>
Klicke den Button unten um den Onboarding Prozess zu starten. (Dies kann nur vom Benutzer selbst ausgeführt werden.)';

$LANG['profile_alert_archive_user'] = 'Der Nutzer wurde archiviert.';
$LANG['profile_alert_archive_user_failed'] = 'Der Benutzer existiert bereits im Archiv. Das kann der gleiche Benutzer oder einer mit selbem Benutzernamen sein.<br>Bitte lösche den archivierten Benutzer zuerst.';
$LANG['profile_alert_create'] = 'Benutzer anlegen';
$LANG['profile_alert_create_success'] = 'Das neue Benutzerkonto wurde angelegt.';
$LANG['profile_alert_delete_user'] = 'Der Nutzer wurde gelöscht.';
$LANG['profile_alert_update'] = 'Benutzerprofil aktualisiert';
$LANG['profile_alert_update_success'] = 'Die Informationen für diesen Benutzer wurden aktualisert.';
$LANG['profile_alert_save_failed'] = 'Die neuen Informationen für diesen Benutzer konnten nicht gespeichert werden. Es gab fehlerhafte Eingaben. Bitte prüfe die Tabs nach Fehlermeldungen.';
...
$LANG['profile_avatar_available'] = 'Verfügbare Standard Avatare';
$LANG['profile_avatar_available_comment'] = 'Wähle einen der standard Avatare, erstellt von <a href="https://www.iconshock.com/icon_sets/vector-user-icons/" target="_blank">IconShock</a>.';
$LANG['profile_avatar_upload'] = 'Avatar hochladen';
$LANG['profile_avatar_upload_comment'] = 'Es kann ein individueller Avatar hochlgeaden werden. Die Dateigröße ist limitiert auf %d Bytes, das Bild sollte
...
$LANG['profile_defaultMenu_comment'] = 'Das TeamCal Neo Menü kann entweder als horizontales Menü oben oder als vertikales Menü links angezeigt werden.
 Das vertikale Menü links eignet sich nur für breite Bidschirme, das horizontale Menü passt sich auch an schmale Bildschirme an (responsive).';
...
$LANG['profile_language_comment'] = 'Hier kann eine benutzerspezifische Sprache für die Oberfläche eingestellt werden.';
...
$LANG['profile_locked_comment'] = 'Das Konto kann hier gesperrt werden, so dass kein Einloggen möglich ist.';
$LANG['profile_managerships'] = 'Manager von';
$LANG['profile_managerships_comment'] = 'Wähle hier die Gruppen, von denen dieser Benutzer Manager ist. Sollte eine Gruppe sowohl hier als auch
      in der Mitgliedsliste gewählt werden, wird die Managerposition übernommen.';
$LANG['profile_memberships'] = 'Mitglied von';
$LANG['profile_memberships_comment'] = 'Wähle hier die Gruppen, in denen dieser Benutzer Mitglied ist. Sollte eine Gruppe sowohl hier als auch
      in der Managerliste gewählt werden, wird die Managerposition übernommen.';
$LANG['profile_menuBar'] = 'Menüzeilenanzeige';
$LANG['profile_menuBar_comment'] = 'Mit diesem Schalter kann die Farbkombination der Menüzeile invertiert werden. Für einige Themes sieht das besser aus.';
...
$LANG['profile_notify_comment'] = 'Wähle die Ereignisse, über die du per E-Mail benachrichtigt werden möchtest. Dies beinhaltet das Anlegen, Ändern und Löschen. Mit Strg + Klick kannst du Ereignisse an- und abwählen.';
...
$LANG['profile_onhold'] = '<i class="far fa-clock text-warning" style="padding-right: 8px;"></i>Temporär gesperrt';
$LANG['profile_onhold_comment'] = 'Dieser Zustand tritt ein, wenn der Benutzer zu häufig ein falsches Passwort eingegeben hat. Dann wirkt die Schonfrist,
 in der das Konto gesperrt ist. Die Länge der Schonfrist kann in der Konfiguration eingestellt werden. Hier kann die Schonfrist manuell wieder aufgehoben werden.';
$LANG['profile_orderkey'] = 'Sortierschlüssel';
$LANG['profile_orderkey_comment'] = 'Du kannst dieses Textfeld benutzen um für diesen Benutzer einen anderen Sortierschlüssel als den Nachnamen zu nutzen. Allerdings wird dies nur in der Kalenderansicht angewendet, wenn der Administrator diese Option eingeschaltet hat.';
$LANG['profile_password'] = 'Passwort';
$LANG['profile_password_comment'] = 'Hier kann ein neues Passwort eingegeben werden. Wenn das Feld leer bleibt, wird das aktuelle Passwort nicht verändert.<br>
...
$LANG['profile_region_comment'] = 'Hier kann die Region gewählt werden, zu der dieser Benutzer gehöhrt.';
$LANG['profile_remove2fa'] = '2FA entfernen';
$LANG['profile_remove2fa_comment'] = 'Du hast bereits eine Authenticator App als zweiten Faktor registriert. Aus Sicherheitsgründen sind die Onboarding Details nicht mehr verfügbar.
 Wenn dieser zweite Faktor entfernt werden soll, z.B. wenn du ein neues mobiles Gerät einrichtest, ticke diese Box und aktualisiere dein Profil. Der Onboarding Link wird danach hier angezeigt.';
$LANG['profile_role'] = 'Rolle';
$LANG['profile_role_comment'] = 'Hier kann die Rolle gewählt werden, die dieser Benutzer einnehmen soll. Damit sind bestimmte Berechtigungen verknüpft.';
$LANG['profile_skype'] = 'Skype';
$LANG['profile_skype_comment'] = '';
$LANG['profile_theme'] = 'Theme';
$LANG['profile_theme_comment'] = 'Hier kann ein benutzerspezifisches Theme für die Oberfläche eingestellt werden.';
...
$LANG['profile_username_comment'] = 'Der Loginname kann für existierende Benutzerkonten nicht geändert werden.';
$LANG['profile_verify'] = '<i class="fas fa-exclamation-circle text-success" style="padding-right: 8px;"></i>Zu verifizieren';
$LANG['profile_verify_comment'] = 'Wenn der Benutzer sich selbst registriert hat, aber die Bestätigung noch nicht durchgeführt hat, gilt dieser Zustand. Der Account ist angelegt
...
$LANG['role_alert_edit_success'] = 'Die Informationen für diese Rolle wurden aktualisiert.';
$LANG['role_alert_save_failed'] = 'Die neuen Informationen für diese Rolle konnten nicht gespeichert werden. Es gab fehlerhafte Eingaben. Bitte prüfe die Fehlermeldungen.';
$LANG['role_alert_save_failed_duplicate'] = 'Die neuen Informationen für diese Rolle konnten nicht gespeichert werden. Eine Rolle mit dem Namen existiert bereits.';
...
$LANG['roles_alert_created_fail_input'] = 'Die Rolle wurde nicht angelegt. Bitte überprüfe den "Rolle anlegen" Dialog nach Eingabefehlern.';
$LANG['roles_alert_created_fail_duplicate'] = 'Die Rolle wurde nicht angelegt. Eine Rolle mit diesem Namen existiert bereits.';
$LANG['roles_alert_deleted'] = 'Die Rolle wurde gelöscht.';
$LANG['roles_confirm_delete'] = 'Bist du sicher, dass du diese Rolle löschen willst?';
...
$LANG['setup2fa_alert_input_help'] = 'Aus Sicherheitsgründen ist der vorherige generierte Barcode und Sicherheitscode nicht mehr gültig.
 Solltest du einen Eintrag damit in deiner Authenticator App angelegt haben, kannst diesen löschen und mit den neuen Informationen auf dieser Seite einen neuen Eintrag anlegen.';
...
$LANG['setup2fa_comment'] = 'Füge einen neuen Eintrag in deiner Authenticator App hinzu, indem du den Barcode einscannst (falls einer angezeigt wird) oder durch manuelle Eingabe des angezeigten Sicherheitscodes.
 Nach Hinzufügen des Eintrages gib den nächsten generierten Code deiner App in das Feld unten ein und klicke auf Verifizieren.';
$LANG['setup2fa_required_comment'] = 'Der Administrator hat konfiguriert, dass eine Zwei Faktor Authentifizierung zum Login erforderlich ist. Hier kannst du den Onboarding Prozess durchführen.
...
$LANG['status_ut_user'] = 'Regulärer Nutzer';
...
$LANG['upl_error_1'] = 'Die hochgeladene Datei übersteigt die maximale Dateigröße der Severkonfiguration.';
...
$LANG['upl_error_10'] = 'Bitte wähle eine Datei zum Hochladen aus.';
$LANG['upl_error_11'] = 'Nur Dateien der folgenden Formate sind erlaubt: %s';
$LANG['upl_error_12'] = 'Der Dateiname enthält ungültige Zeichen. Bitte benutze nur alphanumerische Zeichen und den Unterstrich. Der Dateiname muss mit einem Punkt und der Erweiterung enden.';
$LANG['upl_error_13'] = 'Der Dateiname übersteigt die maximale Länge von %d Zeichen.';
...
$LANG['users_alert_archive_selected_users'] = 'Die ausgewählten Nutzer wurden archiviert.';
$LANG['users_alert_archive_selected_users_failed'] = 'Ein oder mehr Benutzer existieren bereits im Archive. Das kann der gleiche Benutzer oder einer mit selbem Benutzernamen sein.<br>Bitte lösche diese archivierten Benutzer zuerst.';
$LANG['users_alert_delete_selected_users'] = 'Die ausgewählten Nutzer wurden gelöscht.';
$LANG['users_alert_remove_secret_selected'] = 'Die 2FA Secrets der ausgewählten Nutzer wurden entfernt.';
$LANG['users_alert_reset_password_selected'] = 'Die Passwörter der ausgewählten Nutzer wurden zurückgesetzt und eine entsprechende e-Mail an sie versendet.';
$LANG['users_alert_restore_selected_users'] = 'Die ausgewählten Nutzer wurden wiederhergestellt.';
$LANG['users_alert_restore_selected_users_failed'] = 'Ein oder mehr Benutzer existieren bereits als aktive Benutzer. Das kann der gleiche Benutzer oder einer mit selbem Benutzernamen sein.<br>Bitte lösche diese aktiven Benutzer zuerst.';
$LANG['users_attributes'] = 'Attribute';
$LANG['users_attribute_locked'] = 'Konto gesperrt';
$LANG['users_attribute_hidden'] = 'Konto verborgen';
$LANG['users_attribute_onhold'] = 'Konto temporär gesperrt';
$LANG['users_attribute_secret'] = '2FA eingerichtet';
$LANG['users_attribute_verify'] = 'Konto zu verifizieren';
$LANG['users_confirm_archive'] = 'Bist du sicher, dass du die ausgewählten Nutzer archivieren möchtest?';
$LANG['users_confirm_delete'] = 'Bist du sicher, dass du die ausgewählten Nutzer löschen möchtest?';
$LANG['users_confirm_password'] = 'Bist du sicher, dass du die Passwörter der ausgewählten Nutzer zurücksetzen möchtest? Eine E-mail mit der Aufforderung zur Passwortänderung wird an die Nutzer versendet.';
$LANG['users_confirm_restore'] = 'Bist du sicher, dass du die ausgewählten Nutzer wieder aktivieren möchtest?';
$LANG['users_confirm_secret'] = 'Bist du sicher, dass du die 2FA Secrets der ausgewählten Nutzer entfernen möchtest? Die Nutzer können/müssen den Onboarding Prozess dann wiederholen.';
...
$LANG['imp_file_comment'] = 'Lade eine CSV Datei hoch. Details zum Format findest du <a href="https://lewe.gitbook.io/teamcal-neo/administration/users/user-import" target="_blank">hier</a>.
      Die Größe der Datei darf bis zu %d KBytes betragen und kann folgende Formate haben: "%s".';
$LANG['imp_group'] = 'Gruppe';
$LANG['imp_group_comment'] = 'Wähle die Gruppe, der die importierten Benutzer zugeordnet werden sollen.';
$LANG['imp_role'] = 'Rolle';
$LANG['imp_role_comment'] = 'Wähle die Rolle, der die importierten Benutzer zugeordnet werden sollen.';
$LANG['imp_hidden'] = 'Verborgen';
$LANG['imp_hidden_comment'] = 'Wähle diese Option, wenn die importierten Benutzer als "verborgen" gekennzeichnet werden sollen.';
$LANG['imp_locked'] = 'Gesperrt';
$LANG['imp_locked_comment'] = 'Wähle diese Option, wenn die importierten Benutzer als "gesperrt" gekennzeichnet werden sollen.';
