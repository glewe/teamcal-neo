...
if (!empty($_POST))
{
   ...
   if (!formInputValid('txt_lastname', 'required|alpha_numeric_dash_blank')) $inputError = true;
   if (!formInputValid('txt_firstname', 'required|alpha_numeric_dash_blank')) $inputError = true;
...
$viewData['personal'] = array (
   ...
   array ( 'prefix' => 'register', 'name' => 'firstname', 'type' => 'text', 'placeholder' => '', 'value' => '', 'maxlength' => '80', 'mandatory' => true, 'error' =>  (isset($inputAlert['firstname'])?$inputAlert['firstname']:'') ), 
