...
$defaultColor = 'orange';
$chartColor = $rgb[$defaultColor];
$viewData['color'] = $defaultColor;
$viewData['colorHex'] = rgb2hex($rgb[$defaultColor],false);
$viewData['defaultColorHex'] = rgb2hex($rgb[$defaultColor],false);
