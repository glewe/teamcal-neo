...
$releases = [
  ...
  [
    ...
    'info' => 'Bugfix release.',
    'bugfixes' => [
      [ 'summary' => 'Fix repeat header row bug', 'issue' => '' ],
    ],
    'features' => [
    ],
    'improvements' => [
  ...
  [
    ...
    'info' => 'Bugfix release.',
    'bugfixes' => [
      [ 'summary' => 'Fix All-by-group display bug', 'issue' => '' ],
    ],
    'features' => [
    ],
    'improvements' => [
  ...
  [
    ...
    'bugfixes' => [
      ...
      [ 'summary' => 'Fix calendar view settings for logged in users', 'issue' => '' ],
    ],
    'features' => [
    ],
    'improvements' => [
  ...
  [
    ...
    'info' => 'Bugfix release',
    'bugfixes' => [
      [ 'summary' => 'Fix faulty sql files in sql folder', 'issue' => '' ],
    ],
    'features' => [
    ],
    'improvements' => [
  ...
  [
    'version' => '5.0.0',
    'date' => '2026-02-09',
    'info' => 'New major release with complete code refactoring.',
    'bugfixes' => [
    ...
    'improvements' => [
      ...
      [ 'summary' => 'Updated jQuery 3.7.1 to 4.0.0', 'issue' => '' ],
      [ 'summary' => 'Updated jQuery UI 1.14.1 to 1.14.2', 'issue' => '' ],
      [ 'summary' => 'Replaced Securimage CAPTCHA with new internal CaptchaService (Math + Honeypot)', 'issue' => '' ],
      [ 'summary' => 'Set focus on search input in calendar user search dialog', 'issue' => '' ],
      [ 'summary' => 'Allow multiple absence types in absence monitoring', 'issue' => '' ],
  ...
  [
    ...
    'info' => '',
    'bugfixes' => [
      [ 'summary' => 'Installation script bugfix', 'issue' => '' ],
    ],
    'features' => [
    ],
    'improvements' => [
  ...
  [
    ...
    'info' => '',
    'bugfixes' => [
      [ 'summary' => 'Fixed missing CSRF token for iCal import', 'issue' => '' ],
    ],
    'features' => [
    ],
    'improvements' => [
  ...
  [
    ...
    'features' => [
      [ 'summary' => 'Added content narrow and wide mode toggle', 'issue' => '' ],
      [ 'summary' => 'Vertical sidebar menu for wide screens', 'issue' => '' ],
      ...
      [ 'summary' => 'Added Bootstrap Dark and Light mode toggle', 'issue' => 'https://github.com/glewe/teamcal-neo/issues/2' ],
