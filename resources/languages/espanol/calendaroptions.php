...
$LANG['calopt_showTooltipCount_comment'] = 'Si se marca esta opción, se mostrará la cantidad tomada para un tipo de ausencia como "(tomada mes actual/tomada año actual)" en la información sobre herramientas del tipo de ausencia al pasar el mouse sobre ella en el calendario. Nota: Esta configuración consume muchos recursos, ya que requiere consultas adicionales a la base de datos por cada entrada de ausencia. Desactívela en calendarios grandes con muchos usuarios o meses mostrados.';
