...
$LANG['alert_captcha_wrong_help'] = 'The Captcha code must be the correct result of the math question.';
...
$LANG['alert_input_hex_color'] = 'This field allows only a hexadecimal color code with an optional leading hash, e.g. #FF5733 or FF5733.';
