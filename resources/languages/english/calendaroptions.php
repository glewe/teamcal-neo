...
$LANG['calopt_monitorAbsence_comment'] = 'Specify one or more absence types here. For each, the Remainder/Allowance count will be shown below the username in the calendar.';
...
$LANG['calopt_statsDefaultColorPresencetype'] = 'Default Color Presence Type Statistics';
$LANG['calopt_statsDefaultColorPresencetype_comment'] = 'Select the default color for this stattistics page.';
...
$LANG['calopt_statsDefaultColorTrends'] = 'Default Color Trends Statistics';
$LANG['calopt_statsDefaultColorTrends_comment'] = 'Select the default color for this statistics page.';
$LANG['calopt_statsDefaultColorDayofweek'] = 'Default Color Day of Week Statistics';
$LANG['calopt_statsDefaultColorDayofweek_comment'] = 'Select the default color for this statistics page.';
$LANG['calopt_statsDefaultColorDuration'] = 'Default Color Duration Statistics';
$LANG['calopt_statsDefaultColorDuration_comment'] = 'Select the default color for this statistics page.';
