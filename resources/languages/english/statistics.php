...
/**
 * Language strings English: Statistics
 *
...
$LANG['stats_title_presencetype'] = 'Presence Type Statistics';
...
$LANG['stats_presencetype_desc'] = 'This statistics shows all entered presences (absences that count as present) by type.';
...
$LANG['stats_trends_title'] = 'Absence Trends';
$LANG['stats_trends_desc'] = 'Trend of absences over the months for the selected year.';
$LANG['stats_dayofweek_title'] = 'Day of Week Statistics';
$LANG['stats_dayofweek_desc'] = 'Total absences by day of the week for the selected year.';
$LANG['stats_duration_title'] = 'Absence Duration Histogram';
$LANG['stats_duration_desc'] = 'Frequency of absence durations (contiguous days) for the selected year.';
$LANG['stats_tab_trends'] = 'Trends';
$LANG['stats_tab_dayofweek'] = 'Day of Week';
$LANG['stats_tab_duration'] = 'Duration';
$LANG['stats_tab_absence'] = 'Absence';
$LANG['stats_tab_abstype'] = 'Absence Type';
$LANG['stats_tab_presence'] = 'Presence';
$LANG['stats_tab_presencetype'] = 'Presence Type';
$LANG['stats_tab_remainder'] = 'Remainder';
