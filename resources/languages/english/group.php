...
$LANG['group_maxabsentwe_comment'] = 'Enter the maximum amount of absent members for this group on weekends (Saturday and Sunday). This value is checked when absences are requested.<br>A high value exceeding the amount of group members (e.g. 9999) can be used to allow a total absence of the group on weekends.';
...
$LANG['group_minpresentwe_comment'] = 'Enter the minimum amount of present members for this group on weekends (Saturday and Sunday). This value is checked when absences are requested.<br>Enter 0 to allow a total absence of the group on weekends.';
