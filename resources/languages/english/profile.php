...
$LANG['profile_defaultMenu_default'] = 'Default';
...
$LANG['profile_hidden'] = '<i class="far fa-eye-slash text-info me-2"></i>Hide in calendar';
...
$LANG['profile_locked'] = '<i class="fas fa-lock text-danger me-2"></i>Locked';
...
$LANG['profile_onhold'] = '<i class="far fa-clock text-warning me-2"></i>On hold';
...
$LANG['profile_verify'] = '<i class="fas fa-exclamation-circle text-success me-2"></i>Verify';
