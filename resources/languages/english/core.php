 ...
 * @since 4.3.0
 */
$LANG['contact_administrator'] = 'Contact your administrator.';
$LANG['locale'] = 'en_US';
$LANG['html_locale'] = 'en';
...
$LANG['btn_confirm_message'] = 'Confirm Message';
...
$LANG['btn_create_message'] = 'Create Message';
...
$LANG['btn_delete_message'] = 'Delete Message';
...
// Email
//
$LANG['email_subject_absence_approval'] = 'TeamCal Neo Absence Approval Needed';
...
$LANG['email_subject_absence_changed'] = '%app_name% Absence Type Changed';
$LANG['email_subject_absence_created'] = '%app_name% Absence Type Created';
$LANG['email_subject_absence_deleted'] = '%app_name% Absence Type Deleted';
$LANG['email_subject_holiday_changed'] = '%app_name% Holiday Changed';
$LANG['email_subject_holiday_created'] = '%app_name% Holiday Created';
$LANG['email_subject_holiday_deleted'] = '%app_name% Holiday Deleted';
...
// Home Page
//
$LANG['home_title'] = 'Welcome to TeamCal Neo';
...
$LANG['lic_curl_missing'] = 'PHP cURL Extension Missing';
$LANG['lic_curl_missing_subject'] = 'A required PHP extension is not installed.';
$LANG['lic_curl_missing_text'] = 'TeamCal Neo requires the PHP cURL extension to communicate with the license server. Without it, license checks cannot be performed.';
$LANG['lic_curl_missing_help'] = 'Please install the php-curl package on your server (e.g. "apt install php-curl" on Debian/Ubuntu) and restart your web server.';
...
$LANG['mnu_admin_declination'] = 'Declination Rules';
...
$LANG['mnu_help'] = 'Help';
$LANG['mnu_help_about'] = 'About TeamCal Neo';
...
$LANG['mnu_view_stats_presencetype'] = 'Presence Type Statistics';
