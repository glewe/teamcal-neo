...
/**
 * Language strings English: Message page
 *
 ...
 * @since 4.3.0
 */
$LANG['msg_alert_confirmed'] = 'The message has been confirmed.';
$LANG['msg_alert_created'] = 'The message has been created successfully.';
$LANG['msg_alert_created_fail'] = 'The message could not be created.';
$LANG['msg_alert_deleted'] = 'The message has been deleted.';
$LANG['msg_code'] = 'Captcha Code';
$LANG['msg_code_comment'] = 'Please enter the correct result of the math question.';
...
$LANG['msg_msg_sent_failed'] = 'Message sending failed';
$LANG['msg_msg_sent_failed_text'] = 'Your message could not be sent to the selected recipients. Please check your system settings or contact an administrator.';
...
$LANG['msg_type_desc'] = 'Chose the type of message you want to send.<br>A silent message will be put on the user\'s Messages page only.<br>A prompt message will cause the Messages page to show automatically when the user logs in.';
