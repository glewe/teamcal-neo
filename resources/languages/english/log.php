...
/**
 * Language strings English: Log page
 *
...
$LANG['log_clear_confirm'] = 'Are you sure you want to delete all events of the currently selected period?<br>Note, that all events of all event types in the selected period will be deleted, even though you might have hidden them in the Log Settings.';
...
$LANG['log_statistics_last_quarter'] = 'This Quarter';
$LANG['log_statistics_last_year'] = 'This Year';
$LANG['log_statistics_overall'] = 'Overall';
$LANG['log_statistics_event_types'] = 'Event Types';
$LANG['log_statistics_select_all'] = 'Select all';
$LANG['log_statistics_unselect_all'] = 'Unselect all';
...
$LANG['log_license_unavailable'] = 'License information could not be retrieved: ';
...
$LANG['log_login_not_verified'] = 'User account not verified';
...
$LANG['log_login_oidc_no_account'] = 'OIDC: No local account found';
$LANG['log_login_oidc_admin_local_only'] = 'OIDC: Admin account is local-only';
$LANG['log_login_oidc_error'] = 'OIDC: Authentication error';
...
$LANG['log_user_avatar_uploaded'] = 'User avatar uploaded: ';
...
$LANG['log_user_verify_code_notexist'] = 'Verification code does not exist: ';
