...
$LANG['db_clean_daynoteRegions'] = 'Daynote Regions';
$LANG['db_clean_daynoteRegions_comment'] = 'This option checks whether there are daynotes without a region set. If so, the region will be set to Default.';
...
$LANG['db_dbURL_comment'] = 'You can specify a direct link to your preferred database management application for this website. If a valid URL is saved here, a button will be shown that links to it.';
...
$LANG['db_repair_applying'] = 'Applying fixes...';
$LANG['db_repair_backup_warning'] = 'It is strongly recommended to back up your database before applying fixes. Repair operations are not transactional across tables and may take a long time on large databases.';
$LANG['db_repair_checking'] = 'Checking database structure...';
$LANG['db_repair_dbStructure'] = 'Database Structure';
$LANG['db_repair_dbStructure_comment'] = 'This option checks the structure of your current database against the structure shipped with this release. A dialog will show the errors found, allowing you to confirm fixing them.';
$LANG['db_repair_no_issues'] = 'No issues found.';
$LANG['db_repair_select_option'] = 'Please select an option.';
