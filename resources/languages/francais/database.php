...
$LANG['db_clean_daynoteRegions'] = 'Régions des notes de jour';
$LANG['db_clean_daynoteRegions_comment'] = 'Cette option vérifie s\'il existe des notes de jour sans région définie. Si c\'est le cas, la région par défaut leur sera affectée.';
...
$LANG['db_dbURL_comment'] = 'Vous pouvez spécifier un lien direct vers votre application de gestion de base de données préférée pour ce site Web. Si une URL valide est enregistrée ici, un bouton s\'affichera pour y accéder.';
...
$LANG['db_repair_applying'] = 'Application des corrections...';
$LANG['db_repair_backup_warning'] = 'Il est fortement recommandé de sauvegarder votre base de données avant d\'appliquer les corrections. Les opérations de réparation ne sont pas transactionnelles entre les tables et peuvent prendre beaucoup de temps sur de grandes bases de données.';
$LANG['db_repair_checking'] = 'Vérification de la structure de la base de données...';
$LANG['db_repair_dbStructure'] = 'Structure de la base de données';
$LANG['db_repair_dbStructure_comment'] = 'Cette option vérifie la structure de votre base de données actuelle par rapport à la structure livrée avec cette version. Une boîte de dialogue affichera les erreurs trouvées, vous permettant de confirmer leur correction.';
$LANG['db_repair_no_issues'] = 'Aucun problème trouvé.';
$LANG['db_repair_select_option'] = 'Veuillez sélectionner une option.';
