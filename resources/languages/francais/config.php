...
$LANG['config_productionMode'] = 'Mode production';
$LANG['config_productionMode_comment'] = 'Active le mode production pour supprimer les messages d\'erreur et les informations de débogage. Ce paramètre remplace le fichier .env. Lorsqu\'il est activé, toutes les erreurs et avertissements PHP seront masqués aux utilisateurs. Désactivez-le pendant le développement ou le dépannage.';
