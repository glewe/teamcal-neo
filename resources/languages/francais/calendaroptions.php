...
$LANG['calopt_showTooltipCount_comment'] = 'Si cette option est cochée, le montant pris pour un type d\'absence sera affiché sous la forme "(pris mois en cours/pris année en cours)" dans l\'infobulle du type d\'absence lors du survol dans le calendrier. Remarque : Ce paramètre est gourmand en ressources car il nécessite des requêtes de base de données supplémentaires par entrée d\'absence. Désactivez-le pour les grands calendriers avec de nombreux utilisateurs ou mois affichés.';
...
$LANG['calopt_statsDefaultColorTrends'] = 'Couleur par défaut Statistiques de tendances';
$LANG['calopt_statsDefaultColorTrends_comment'] = 'Sélectionnez la couleur par défaut pour cette page de statistiques.';
$LANG['calopt_statsDefaultColorDayofweek'] = 'Couleur par défaut Statistiques par jour';
$LANG['calopt_statsDefaultColorDayofweek_comment'] = 'Sélectionnez la couleur par défaut pour cette page de statistiques.';
$LANG['calopt_statsDefaultColorDuration'] = 'Couleur par défaut Statistiques de durée';
$LANG['calopt_statsDefaultColorDuration_comment'] = 'Sélectionnez la couleur par défaut pour cette page de statistiques.';
...
$LANG['calopt_supportMobile'] = 'Prise en charge des appareils mobiles (Obsolète)';
$LANG['calopt_supportMobile_comment'] = 'Cette option est obsolète. Le calendrier détecte désormais automatiquement la largeur de l\'écran et ajuste l\'affichage en conséquence. Aucune configuration manuelle n\'est requise.';
