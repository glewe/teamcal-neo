...
$CONF['controllers'] = array (
   ...
   'useredit' => new Controller('useredit', 'edit', 'warning', 'danger', 'useredit', 'User Edit'),
   ...
   'remainder' => new Controller('remainder', 'calendar-check-o', 'success', 'primary', 'remainder', 'Remainder View'),
