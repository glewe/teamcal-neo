...
$CONF['controllers']   = array(
  ...
  'userlist'          => new Controller('userlist', 'bi-person', $CONF['menuIconColor'], 'primary', 'admin', 'Users', 'https://lewe.gitbook.io/teamcal-neo/administration/users/'),
  ...
  'absencesummary'    => new Controller('absencesummary', 'bi-list-ul', $CONF['menuIconColor'], 'default', 'absum', 'Absence Summary', 'https://lewe.gitbook.io/teamcal-neo/user-guide/statistics/user-absence-summary/'),
